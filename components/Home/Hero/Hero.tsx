  ...
  return (
    <div className="relative h-screen flex items-center justify-center text-white overflow-hidden flex-col">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        ></Image>
        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:6xl xl:7xl mt-6 text-center font-bold tracking-wide">
          Designing with purpose. <br />
          <span className="text-cyan-200">Building with code.</span>
        </h1>
        <h2 className="mt-5 text-sm px-2 text-center sm:text-2xl font-medium flex items-center">
          I'm Rishabh - A Passionate
